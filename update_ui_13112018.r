           ...
           sidebarLayout(
             sidebarPanel(
               ...
               actionButton('rpart5', label = 'SAMPLE RECORDS',icon("tree-conifer",lib="glyphicon"), 
                            style="color: #fff; background-color: #339933; border-color: #2e6da4"),
               actionButton('rpart6', label = 'COUNT VALIDATION',icon("tree-conifer",lib="glyphicon"), 
                            style="color: #fff; background-color: #339933; border-color: #2e6da4"),
               actionButton('rpart7', label = 'SOURCE TARGET COMPARISON',icon("tree-conifer",lib="glyphicon"), 
                            style="color: #fff; background-color: #339933; border-color: #2e6da4")
