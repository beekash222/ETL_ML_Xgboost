...
for i in range (0, len(diff_output)):
    if diff_output['has_change'].ix[i] == "Y":
        worksheet1.write(i+1, diff_output.columns.get_loc("has_change")+1, diff_output['has_change'].ix[i], format1)
    elif diff_output['has_change'].ix[i] == "N":
        worksheet1.write(i+1, diff_output.columns.get_loc("has_change")+1, diff_output['has_change'].ix[i], format3)
